...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(length) => "Value must have a length equal to ${length}";

  static String m2(size) => "This field size have to smaller than ${size}";

  static String m3(max) => "Value must be less than or equal to ${max}";

  static String m4(maxLength) =>
      "Value must have a length less than or equal to ${maxLength}";

  static String m5(min) => "Value must be greater than or equal to ${min}.";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "maxErrorText": m3,
        "maxLengthErrorText": m4,
        "minErrorText": m5,
        "minLengthErrorText": m6,
